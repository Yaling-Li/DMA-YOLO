...
images_dir = "/data/lg/UAVDT/images"
labels_dir = "/data/lg/UAVDT/labels"

tra_img_dir = "/data/lg/UAVDT/train/images"
val_img_dir = "/data/lg/UAVDT/val/images"

tra_labels_dir = "/data/lg/UAVDT/train/labels"
val_labels_dir = "/data/lg/UAVDT/val/labels"
...
d = 24441
tra_filename = labels_filename[:d]
val_filename = labels_filename[d:]
